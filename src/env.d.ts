...
declare global {
  interface Window {
    api: {
      ...
      skinsSetOfficialActive: (accountId: string, skinId: string) => Promise<{
        accountId: string;
        username: string;
        skinUrl: string | null;
        skinDataUrl: string | null;
      ...
      profilePublishPublic: (payload: unknown) => Promise<{
        shareId: string;
      ...
      instancesPreviewIconDataUrl: (iconToken: string) => Promise<string>;
