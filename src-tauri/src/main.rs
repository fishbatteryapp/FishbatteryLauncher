...
fn main() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::window_shell::window_set_fullscreen,
      commands::window_shell::window_set_size,
      ...
      commands::accounts_capes::capes_upload_local_custom,
      ...
      commands::runtime_ops::instances_open_subfolder,
      commands::runtime_ops::instance_world_open_folder,
      commands::runtime_ops::instance_worlds_list,
      commands::runtime_ops::instance_world_sync_prepare_archive,
      commands::runtime_ops::world_sync_upload_archive,
      commands::runtime_ops::world_sync_remove_temp_file,
      commands::runtime_ops::world_sync_download_and_extract,
      ...
      commands::runtime_ops::instance_content_check_updates,
      commands::runtime_ops::content_reveal_file,
      ...
      commands::runtime_ops::servers_refresh_status,
      ...
      commands::runtime_ops::curseforge_mods_search,
      commands::runtime_ops::curseforge_mods_install,
